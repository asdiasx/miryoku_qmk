...
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_SPC),  LT(U_MOUSE,KC_TAB),LT(U_SYM,KC_BSPC),  LT(U_NUM,KC_DEL), LT(U_FUN,KC_ENT),  U_NP,              U_NP
...
U_NA,              KC_ALGR,           TD(U_TD_U_NUM),    TD(U_TD_U_NAV),    STRNIB,            KC_INS,            KC_HOME,           KC_PGDN,           KC_PGUP,           KC_END,            \
